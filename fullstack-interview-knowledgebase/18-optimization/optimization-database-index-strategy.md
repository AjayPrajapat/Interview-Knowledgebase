# Optimization Database Index Strategy
...
How do you optimize a slow transactional query workload using indexing and query rewrites?
...
- Core principles of Optimization Database Index Strategy
- Composite indexes, covering indexes, cardinality, execution plans
...
Optimization Database Index Strategy is typically assessed through real production constraints rather than textbook definitions alone. A strong answer defines the concept, then connects it to architecture boundaries, data flow, failure modes, and operational impact.
...
Warn about write amplification and index bloat from over-indexing.
