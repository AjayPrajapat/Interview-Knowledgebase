# Migrations Zero Downtime Database Change
...
Explain a zero-downtime strategy for a breaking database schema change.
...
- Core principles of Migrations Zero Downtime Database Change
- Expand-contract pattern, backfills, dual writes, rollback plan
...
Migrations Zero Downtime Database Change is typically assessed through real production constraints rather than textbook definitions alone. A strong answer defines the concept, then connects it to architecture boundaries, data flow, failure modes, and operational impact.
...
Never couple destructive migrations with immediate code assumptions.
