# Code Review High Impact Checklist
...
What do you focus on during code review to maximize quality and team velocity?
...
- Core principles of Code Review High Impact Checklist
- Correctness, readability, security, operability, test quality
...
Code Review High Impact Checklist is typically assessed through real production constraints rather than textbook definitions alone. A strong answer defines the concept, then connects it to architecture boundaries, data flow, failure modes, and operational impact.
...
Differentiate blocking issues from optional improvements.
