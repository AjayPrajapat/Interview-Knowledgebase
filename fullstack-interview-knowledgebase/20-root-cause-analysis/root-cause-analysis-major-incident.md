# Root Cause Analysis Major Incident
...
How do you run root cause analysis after a major outage?
...
- Core principles of Root Cause Analysis Major Incident
- Timeline reconstruction, contributing factors, corrective actions, ownership
...
Root Cause Analysis Major Incident is typically assessed through real production constraints rather than textbook definitions alone. A strong answer defines the concept, then connects it to architecture boundaries, data flow, failure modes, and operational impact.
...
Focus on systemic fixes over individual blame.
